...
const test = {
 ...
 db: {
  host: process.env.TEST_DB_HOST || 'ec2-34-252-35-249.eu-west-1.compute.amazonaws.com',
  port: parseInt(process.env.TEST_DB_PORT) || 5432,
  user: process.env.TEST_DB_USER || 'dsqksqybiecasp',
  password: process.env.TEST_DB_PASSWORD || '14dc3dd5a841f76e6698872cbb806030294d661af78b82440133d2417f1607fa',
  name: process.env.TEST_DB_NAME || 'dfc8nvqq60i3fb',
  dialect: process.env.TEST_DB_DIALECT || 'postgres',
  pool: {
    max: parseInt(process.env.TEST_DB_max) || 5,
    min: parseInt(process.env.TEST_DB_min) || 0,
    acquire: parseInt(process.env.TEST_DB_acquire) || 30000,
    idle: parseInt(process.env.TEST_DB_idle) || 10000
  }
 }
};
